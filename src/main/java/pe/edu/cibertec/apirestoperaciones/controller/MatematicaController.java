...
public class MatematicaController {
    ...
    public ResponseEntity<MensajeResponse> suma(@RequestParam Integer numero1,
        ...
        return new ResponseEntity<>(matematicaService.suma(numero1, numero2), HttpStatus.OK);
    }
    public ResponseEntity<MensajeResponse> promedioCibertec(@RequestParam Integer cl1,
                                                            ...
                                                            @RequestParam(defaultValue = "20", required = false) Integer ap,
                                                            @RequestParam Integer pf){
    return new ResponseEntity<>(matematicaService.promedioCibertec(cl1,cl2,cl3,ap,pf), HttpStatus.OK);
    }

    @GetMapping("/primos")
    public ResponseEntity<List<Integer>> listaNumerosPrimos(@RequestParam(name = "listarhasta") Integer hasta){
        return new ResponseEntity<>(matematicaService.listarNumeroPrimos(hasta),HttpStatus.OK);
    }
}
